...
// import { entraApp } from '../../utils/entraApp';
// import { CheckStatus, formatting } from '../../utils/formatting';
// import { pid } from '../../utils/pid';
// import { session } from '../../utils/session';
// import { sinonUtil } from '../../utils/sinonUtil';
// import commands from './commands';
// import { CliExperience, CliUsageMode, EntraAppConfig, HelpMode, NewEntraAppScopes, Preferences, SettingNames } from './setup';
...
//     sinon.stub(cli, 'promptForSelection').callsFake(async (config: any): Promise<unknown> => {
...
//       }
//     });
//     sinon.stub(cli, 'promptForConfirmation').callsFake(async (config: any): Promise<boolean> => {
//       switch (config.message) {
