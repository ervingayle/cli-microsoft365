...
import { Localization, ProfileCardProperty, profileCardPropertyNames as allProfileCardPropertyNames } from './profileCardProperties';
...
module.exports = new TenantPeopleProfileCardPropertySetCommand();