...
// import url from 'url';
// import { z } from 'zod';
// import Command, { CommandError, globalOptionsZod } from '../Command';
// import AnonymousCommand from '../m365/base/AnonymousCommand';
// import cliCompletionUpdateCommand from '../m365/cli/commands/completion/completion-clink-update';
// import { settingsNames } from '../settingsNames';
// import { telemetry } from '../telemetry';
// import { browserUtil } from '../utils/browserUtil';
// import { md } from '../utils/md';
// import { pid } from '../utils/pid';
// import { Choice, prompt, SelectionConfig } from '../utils/prompt';
...
//     log = [];
//     cli.commands = [
//       cli.getCommandInfo(mockCommand, 'cli-mock', 'help.mdx'),
//       cli.getCommandInfo(mockCommandWithAutocomplete, 'cli-autocomplete-mock', 'help.mdx'),
//       cli.getCommandInfo(mockCommandWithOptionSets, 'cli-optionsets-mock', 'help.mdx'),
//       cli.getCommandInfo(mockCommandWithAlias, 'cli-alias-mock', 'help.mdx'),
//       cli.getCommandInfo(mockCommandWithValidation, 'cli-validation-mock', 'help.mdx'),
//       cli.getCommandInfo(mockCommandWithSchema, 'cli-schema-mock', 'help.mdx'),
//       cli.getCommandInfo(mockCommandWithSchemaAndRequiredOptions, 'cli-schema-mock', 'help.mdx'),
//       cli.getCommandInfo(cliCompletionUpdateCommand, 'cli/commands/completion/completion-clink-update', 'cli/completion/completion-clink-update.mdx'),
//       cli.getCommandInfo(mockCommandWithBooleanRewrite, 'cli-boolean-rewrite-mock', 'help.mdx')
//     ];
...
//     sinon.stub(fs, 'existsSync').callsFake((path) => path.toString().endsWith('.mdx') || path.toString().endsWith('-mock'));
...
//     await sinon.stub(cli, 'loadCommandFromFile').returns(cli.loadCommandFromFile as any).wrappedMethod.apply(cli, [path.join(rootFolder, 'CommandInfo')]);
